...
export default function SignupPage() {
  // Always start in light mode on signup page
  React.useEffect(() => {
  ...
  // Signup logic: set current user and redirect
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-700 p-4">
      ...
      <Card className="w-full max-w-sm border-green-200 shadow-lg bg-white/90 dark:bg-zinc-900/90">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold font-headline text-green-900 dark:text-zinc-100">Create your Account</CardTitle>
          <CardDescription className="text-green-800 dark:text-green-300">Enter your email and a password to get started</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-4 text-center text-sm text-green-800">
            ...
            <a href="/login" className="underline font-semibold text-green-700 hover:text-green-900">
              Login
            </a>
          </div>
        </CardContent>
